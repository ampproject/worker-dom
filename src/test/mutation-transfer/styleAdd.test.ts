...
test.serial('Element.style transfer multiple values, via setProperty', async (t) => {
  const { document, emitter } = t.context;
  const div = document.createElement('div');
...
test.serial('Element.style transfer single value, via cssText', async (t) => {
  const { document, emitter } = t.context;
  const div = document.createElement('div');
...
test.serial('Element.style transfer multiple values, via cssText', async (t) => {
  const { document, emitter } = t.context;
  const div = document.createElement('div');
